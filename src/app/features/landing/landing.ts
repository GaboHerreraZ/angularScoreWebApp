...
import { StudyTypesWidget } from './components/study-types-widget/study-types-widget';
import { StudyTeaserWidget } from './components/study-teaser-widget/study-teaser-widget';
...
@Component({
    ...
    standalone: true,
    imports: [ButtonModule, DialogModule, HeaderWidget, HeroWidget, OverviewWidget, ProductDemoWidget, StudyTypesWidget, StudyTeaserWidget, BenefitsWidget, JoinWidget, FooterWidget],
