        ...
        <section id="testimonials" class="px-6 sm:px-12 lg:px-20 py-16 lg:py-24 bg-surface-50 dark:bg-surface-900">
            <div class="max-w-screen-2xl mx-auto">
                <div class="text-center mb-16" appScrollAnimate="fade-up">
                    ...
                    <p class="text-lg text-muted-color max-w-2xl mx-auto">Empresas en Colombia ya confían en Creditia para sus decisiones crediticias</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <article appScrollAnimate="fade-up" [animateDelay]="100" class="bg-surface-0 dark:bg-surface-950 rounded-2xl p-8 border border-surface hover:shadow-lg transition-all duration-300">
                        ...
                        <p class="text-color leading-relaxed mb-6 italic">"El scoring de riesgo nos permite tomar decisiones objetivas y respaldadas por datos. Hemos reducido la cartera vencida en un 35% desde que implementamos Creditia."</p>
                        <div class="flex items-center gap-3">
