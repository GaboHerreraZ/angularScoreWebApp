            ...
            <div class="max-w-3xl mx-auto">
                ...
                <p-accordion appScrollAnimate="fade-up" [animateDelay]="100" [multiple]="true" expandIcon="pi pi-plus" collapseIcon="pi pi-minus">
                    <p-accordion-panel value="0">
                        <p-accordion-header>¿Qué es Riskia y para quién está diseñado?</p-accordion-header>
                        <p-accordion-content>
                            <p class="text-muted-color leading-relaxed m-0">
                                Riskia es una plataforma de análisis crediticio diseñada para empresas colombianas que otorgan crédito a sus clientes.
                    ...
                    <p-accordion-panel value="3">
                        <p-accordion-header>¿Puedo usar Riskia gratis?</p-accordion-header>
                        <p-accordion-content>
                            <p class="text-muted-color leading-relaxed m-0">
